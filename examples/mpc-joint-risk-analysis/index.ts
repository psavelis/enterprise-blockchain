...
engine.registerParty({
  ...
  endpoint: "meridian.example.com",
});
engine.registerParty({
  id: "bank-hansa",
  name: "Hansa Trade Bank",
  endpoint: "hansa.example.com",
});
...
> = {
  "bank-meridian": {
    defaultRate: 312,
    exposureUsd: 84_000_000,
    avgCreditScore: 710,
  },
  "bank-hansa": {
    defaultRate: 287,
    exposureUsd: 61_000_000,
    avgCreditScore: 725,
  },
};
...
const exposureThreshold = engine.compute(
  `exposure-bank-meridian`,
  "threshold",
  {
